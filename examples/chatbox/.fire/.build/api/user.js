...
app.post('/api/users/:id/messages', function(request, response, app,  UserModel) {
	return findAuthenticator(UserModel, request)
		.then(function(authenticator) {
			var property = UserModel.getProperty('messages');
		...
		.then(function(authenticator) {
			var association = UserModel.getAssociation('messages');
			var associatedModel = association.getAssociatedModel();
...
app.get('/api/users/:id/messages', function(request, response, app,  UserModel) {
	return findAuthenticator(UserModel, request)
		.then(function(authenticator) {
			var association = UserModel.getProperty('messages');
			var associatedModel = association.options.relationshipVia.model;
...
app.delete('/api/users/:id/messages/:associationID', function(request, response, app,  UserModel) {
	return findAuthenticator(UserModel, request)
		.then(function(authenticator) {
			var association = UserModel.getProperty('messages');
			var associatedModel = association.getAssociatedModel();
...
app.delete('/api/users/:id/messages', function(request, response, app,  UserModel) {
	return findAuthenticator(UserModel, request)
		.then(function(authenticator) {
			var association = UserModel.getProperty('messages');
			var associatedModel = association.getAssociatedModel();
...
app.put('/api/users/:id/messages/:associationID', function(request, response, app,  UserModel) {
	return findAuthenticator(UserModel, request)
		.then(function(authenticator) {
			var association = UserModel.getProperty('messages');
			var associatedModel = association.options.relationshipVia.model;
...
app.put('/api/users/:id/messages', function(request, response, app,  UserModel) {
	return findAuthenticator(UserModel, request)
		.then(function(authenticator) {
			var association = UserModel.getProperty('messages');
			var associatedModel = association.options.relationshipVia.model;
