...
app.post('/api/shareds', function(app, response, request, SharedModel, UserModel) {
...
app.get('/api/shareds', function(request, response, app,  SharedModel, UserModel) {
	return findAuthenticator(UserModel, request)
		.then(function(authenticator) {
			var accessControl = SharedModel.getAccessControl();
...
app.get('/api/shareds/:id', function(request, response, app,  SharedModel, UserModel) {
	return findAuthenticator(UserModel, request)
		.then(function(authenticator) {
			var accessControl = SharedModel.getAccessControl();
...
app.put('/api/shareds/:id', function(request, response, app,  SharedModel, UserModel) {
	var accessControl = SharedModel.getAccessControl();
	return findAuthenticator(UserModel, request)
		.then(function(authenticator) {
...
app.delete('/api/shareds', function(request, response, app,  SharedModel, UserModel) {
	return findAuthenticator(UserModel, request)
		.then(function(authenticator) {
			var accessControl = SharedModel.getAccessControl();
...
app.delete('/api/shareds/:id', function(request, response, app,  SharedModel, UserModel) {
	return findAuthenticator(UserModel, request)
		.then(function(authenticator) {
			var accessControl = SharedModel.getAccessControl();
			return Q.when(accessControl.canDelete({authenticator: authenticator, request: request, response: response}))
