...
Migration.prototype.addSql = function(md5, query) {
    this._sql[md5] = query;
};
        ...
        .then(function() {
            ...
            if(direction == 'up') {
                ...
                var createSchema = function(count) {
                    ...
                    self.models.execute('INSERT INTO schemas (version, checksum, app) VALUES (?, ?, ?)', [self.version, self.checksum, self.models.app.name])
                        .then(function() {
                            defer2.resolve();
                        })
                        .catch(function(error) {
                ...
                self.models.execute('DELETE FROM schemas WHERE version = ? AND app = ?', [self.version, self.models.app.name])
                    .then(function() {
                        defer.resolve();
                    })
                    .catch(function(error) {
