...
Router.prototype.createRoutes = function() {
	...
	for(routeName in this.controllerConstructor.prototype) {
		...
		if(routeName.length && typeof Controller.prototype[routeName] == 'undefined' && routeName[0] != '_' && (typeof route == 'function' || Array.isArray(route) && route.length == 2 && typeof route[1] == 'function')) {
...
Router.prototype.createRoute = function(routeName) {
	...
	if(Array.isArray(this.controllerConstructor.prototype[routeName])) {
