 ...
 * @param {String} filePath              The file path to the controller. If the controller is included in a subdirectory in `controllers/` and Controller#basePathComponents is not set, the subdirectory is prepended to all route paths.
 */
