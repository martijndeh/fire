...
/**
 * [ClockTask description]
 *
 * @private
 *
 * @param {String}   timingPattern [description]
 ...
 * @constructor
 */
function ClockTask(timingPattern, timeZone, name, callback) {
	this._name = name;
	this._job = new cron.CronJob(timingPattern, this.run.bind(this), null, false, timeZone);
