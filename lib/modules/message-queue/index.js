...
var MessageQueuePostgres = require('./providers/message-queue-pg');
 ...
 */
MessageQueue.factory = function(datastore) {
	var messageQueue = null;

	if(datastore) {
		messageQueue = new MessageQueuePostgres(process.env.DATABASE_URL);
	}
	else if(process.env.BROKER_URL) {
