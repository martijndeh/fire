...
Static.prototype.setup = function() {
	...
	this.app.HTTPServer.express.use('/bower_components', function(next) {
		var string = 'Warning: bower is deprecated in favor of npm to start supporting CommonJS, Babel.js and ES6.';
		console.log(string);
