...
Channels.prototype.generator = function() {
	return new this.app.bridge.Generator(path.join(__dirname, 'templates', this.app.type, 'channel-services-js.mu'), {channels: Object.keys(this._constructors).map(function(name) {
		return {name: name};
	})});
};
