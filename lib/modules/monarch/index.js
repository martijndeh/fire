...
Monarch.prototype._createWriteStream = function(path) {
...
Monarch.prototype._generateStart = function(writeStream) {
	return this._renderTo('start.mu', {}, writeStream);
};
...
Monarch.prototype._generateLocalControllers = function(writeStream) {
	...
	if(controllerNames.length > 0) {
		...
		return this._renderTo('controllers.mu', {controllers: controllers}, writeStream);
	}
