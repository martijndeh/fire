 ...
 * @param  {Array} optionsMap.select The properties to select. This is useful if you want to limit the number of properties to fetch. If the property is an non-auto fetched association, the association is not fetched automatically. To fetch non-auto fetched associations, use the `optionsMap.associations` key.
