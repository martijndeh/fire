...
/**
 * Creates a stream on this model.
 *
 * Finds and returns all model instances matching `whereMap`. This method does a regular {@link Model#find} and returns a stream with these model instances, but when new model instances get created which match `whereMap` these instances will automatically be added to the stream.
 *
 * This method is available on the front-end. This method is not yet available on the back-end.
 *
 * @param  {Dictionary} whereMap   The where
