...
Table.prototype.addProperties = function() {
	throw new Error('Table#addProperties is deprecated.');
};

Table.prototype.removeProperties = function() {
	throw new Error('Table#removeProperties is deprecated.');
};

Table.prototype.addProperty = function() {
	throw new Error('Table#addProperty is deprecated.');
};
