	...
	if(property.isAssociation()) {
		...
		if(property.isManyToMany()) {
			...
			methodsMap['get' + plural] = function(whereMap, optionsMap) {
				var fields = whereMap || {};
				fields[property.options.relationshipVia.name + '.' + property.options.relationshipVia.options.throughPropertyName] = self;
			...
			methodsMap['add' + singular] = function(modelInstanceOrCreateMapOrUUID) {
				return Q.when(modelInstanceOrCreateMapOrUUID)
					...
					.then(function(modelInstanceOrUUID) {
						...
						fields[property.options.relationshipVia.options.throughPropertyName] = self;
						fields[property.options.throughPropertyName] = modelInstanceOrUUID;
			...
			methodsMap['remove' + singular] = function(modelInstanceOrUUID, optionsMap) {
				var fields = {};
				fields[inflection.camelize(associatedModel.getName(), true)] = modelInstanceOrUUID;
