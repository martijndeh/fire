...
/**
 * Internally calls the hooks. The following hooks are supported:
 *
 * 	- beforeLoad: invoked when the model instance loads, before any of the properties are set.
 ...
 * 	- afterCreate: invoked after a new instance is created.
 *
