	...
	Authenticate: function() {
		return function(property) {
			...
			var migrate = function() {
				...
				var modelName = model.getName() + 'ResetPassword';
				var resetPasswordModel = model.models.findModel(modelName);
				if(!resetPasswordModel) {
					resetPasswordModel = model.models.createModel(modelName, {
				...
				model.models.sharedModelNames.push(modelName);
