...
var propertyTypes = {
	...
	*/
	 ...
	 *
	 * @param {String|Function } readOnly SQLish statement.
	 */
	...
	/**
	 * Creates one or more virtual properties and transforms all values to one value.
	 *
	 * ```
	 * function Test() {
	 ...
	 * ```
	 *
	 * Now to use the aggregate property:
	 *
	 * ```
