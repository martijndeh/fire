...
AccessControl.prototype._canAccess = function(type, privateMap) {
	function canAccess(self) {
		var accessFunction = self._[type];
		...
		if(typeof accessFunction == 'function') {
			return self.app.injector.call(accessFunction, privateMap);
		}
		...
		return (accessFunction === true);
	}

	var access = canAccess(this);

	if(access instanceof ModelInstance) {
