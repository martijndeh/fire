 ...
 * @return {Boolean}
 */
AccessControl.prototype.canCreate = function(app, privateMap) {
	var functionOrKeyPath = this._.create;

	if(typeof functionOrKeyPath == 'function') {
		return app.injector.call(functionOrKeyPath, privateMap);
	}
	...
	if(typeof functionOrKeyPath == 'undefined') {
...
* @return {Boolean}
*/
AccessControl.prototype.canRead = function(app, privateMap) {
...
AccessControl.prototype.getPermissionFunction = function(action) {
	...
	// TODO: What if functionOrKeyPath is a string? A key path, that is.
