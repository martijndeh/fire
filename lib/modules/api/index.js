 ...
 * The API module.
 *
 * This module generates the model api during build phase and executes the generated api in the run phase.
 *
...
API.prototype.generateModelController = function(model, writeStream) {
	...
	var readStream = mu.compileAndRender(path.join(__dirname, 'assets', 'model-controller.js'), {
