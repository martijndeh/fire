 ...
 * @param  {String} html Sets the html of the template. If not set, returns the template's html.
...
Templates.prototype.createTemplateRoute = function(templateName) {
    debug('addTemplate ' + templateName);

    var self = this;
    this.app.HTTPServer.express.get('/templates/' + templateName + '.html', function(request, response) {
