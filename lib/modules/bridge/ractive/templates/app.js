...
App.prototype.location = function(location, state, title, dontPush) {
	...
	if(path.indexOf('//') === 0 || (path.indexOf('http://') === 0 || path.indexOf('https://') === 0) && path.indexOf(window.location.origin) !== 0 || !dontPush && typeof window.history.pushState == 'undefined') {
