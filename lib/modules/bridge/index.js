 ...
 * @const
 */
Bridge.prototype.methodNames = ['animation', 'config', 'constant', 'directive', 'factory', 'filter', 'provider', 'service', 'run'];
 ...
 **/
Bridge.prototype.directoryNames = ['services', 'directives', 'filters', 'providers', 'factories', 'values', 'constants', 'decorators', 'config'];
