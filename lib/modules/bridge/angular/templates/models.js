...
FireModelInstance{{name}}.prototype = Object.create(FireModelInstance.prototype);
...
FireModelInstance{{name}}.prototype.get{{methodName}} = function(queryMap, optionsMap) {
    ...
    return this._model.models.{{modelName}}._find(this._model.endpoint + '/' + this.id + '/{{resource}}', queryMap, optionsMap)
        .then(function(modelInstance) {
            if(modelInstance) {
                if(modelInstance) {
					modelInstance._endpoint = self._model.models.{{modelName}}.endpoint + '/' + modelInstance.id;
				}
...
FireModelInstance{{name}}.prototype.update{{pluralMethodName}} = function(where, set) {
    var self = this;
    return this._model.models.{{modelName}}._put(this._model.endpoint + '/' + this.id + '/{{resource}}', transformQueryMap(set), transformQueryMap(where))
...
FireModelInstance{{name}}.prototype.{{getMethodName}} = function(queryMap, optionsMap) {
    ...
    var defer = this._model.$q.defer();
    var path = this._model.endpoint + '/' + this.id + '/{{resource}}';

    var self = this;
    this.$http({method: 'get', url: path, data: null, params: params, headers: {'x-json-params': true}})
    .success(function(result) {
...
FireModel{{name}}.prototype = Object.create(FireModel.prototype);
