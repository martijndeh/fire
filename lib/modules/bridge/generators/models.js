...
exports = module.exports = function() {
	...
	this.app.models.forEach(function(model) {
		if(!model.isPrivate) {
			...
			[modelName + 'Model', '$q', '$http', '$injector', 'FireModelInstance'].forEach(function(dependency) {
			...
			var autoFetchedAssociationNames = [];
			...
			if(model.isAuthenticator()) {
				modelDependencies.push('_CacheService');
				modelDependencyNames.push('\'_CacheService\'');
			}
			...
			models.push({
				name: modelName,
				autoFetchedAssociationNames: autoFetchedAssociationNames.join(', '),
