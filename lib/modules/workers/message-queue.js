...
/**
 * The base message queue class. This should be "subclassed" (prototypal inheritance...) by specific implementations.
 *
...
/**
 * Starts consuming messages on a specific queue named `queueName`. The exact implementation is up to the subclass.
 *
 ...
 */
MessageQueue.prototype.startConsuming = function(queueName, callback) { //jshint ignore:line
	throw new Error('MessageQueue#startConsuming not implemented. Implement this method in the MessageQueue subclass.');
};

/**
 * Publishes a message to the queue name.
 *
 * @param {String} queueName  The queue name to publish to.
 * @param {String} methodName The name of the method originally invoked on the worker.
 * @param {Array} params     The arguments provided when the method was invoked.
 */
MessageQueue.prototype.publishMessage = function(queueName, methodName, params) { //jshint ignore:line
	throw new Error('MessageQueue#publishMessage not implemented. Implement this method in the MessageQueue subclass.');
};
