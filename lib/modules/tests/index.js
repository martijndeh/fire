...
Tests.prototype.migrate = function(models) {
	...
	if(typeof models.TestParticipant == 'undefined') {
		...
		Test.prototype.isPrivate = true;
		models.addModelConstructor(Test);

		util.inherits(TestSession, Model);
		TestSession.prototype.isPrivate = true;
	...
	if(authenticator) {
		models.TestParticipant._addProperty('authenticator', [models.TestParticipant.BelongsTo(authenticator), models.TestParticipant.Optional]);
