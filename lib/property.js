...
function Property(name, types, model, models) {
	...
	Object.defineProperty(this, 'referenceName', {
		get: function() {
			throw new Error('`referenceName` is deprecated. Use `options.referenceName` instead.');
		},

		set: function(value) {
			throw new Error('Setting referenceName is deprecated.');
		}
	});

	Object.defineProperty(this, 'autoFetch', {
		get: function() {
			throw new Error('`autoFetch` is deprecated. Use `options.autoFetch` instead.');
		},

		set: function(value) {
			throw new Error('Setting autoFetch is deprecated.');
		}
	});

	Object.defineProperty(this, 'required', {
		get: function() {
			throw new Error('`required` is deprecated. Use `options.required` instead.');
		},

		set: function(value) {
			throw new Error('Setting required is deprecated.');
		}
	});
...
Property.prototype.isAllowed = function() {
	return (!this.options.hasMany) && (!this.options.hasOne);
};
