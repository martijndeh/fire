...
function App() {
	...
	this.models = new Models(this, this.workers);
...
App.prototype._configureConnection = function(controllerConstructor, action, viewPath) {
...
App.prototype.addRoute = function(verb, url, controllerConstructor, action, viewPath) {
	if(this.server[verb] && typeof this.server[verb] == 'function') {
		this.server[verb].call(this.server, url, this._configureConnection(controllerConstructor, action, viewPath));
	}
	else {
