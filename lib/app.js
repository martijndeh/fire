...
App.prototype.controller = function(controllerConstructor) {
	// Move this to the controllers module.
...
App.prototype._setup = function() {
	...
	return result
		.then(function() {
			...
			result = Q.when(true);
			self._configureFunctions.forEach(function(configureFunction) {
				result = result.then(function() {
...
App.prototype.configure = function(configureFunction) {
	this._configureFunctions.push(configureFunction);
};
