...
Migrations.prototype.addMigration = function(MigrationClass, version) {
    ...
    //utils.implements(MigrationClass.prototype, Table.propertyTypes);
    //Table.extends(MigrationClass.prototype);
    //MigrationClass.implements(Table.propertyTypes);
    ...
    Object.keys(Table.propertyTypes).forEach(function(propertyName) {
        ...
        if(!MigrationClass.prototype[propertyName]) {
            MigrationClass.prototype[propertyName] = Table.propertyTypes[propertyName];
        }
    });
