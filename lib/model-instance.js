		...
		if(property.referenceName && property.autoFetch) {
			...
			if(property.autoFetch) {
				Object.defineProperty(self, propertyName, {
					get: function() {
						return self._references[propertyName]; //new ModelInstance(self._model, self._references[propertyName], null);
					},
...
ModelInstance.prototype.parseRow = function(row) {
	...
	Object.keys(references).forEach(function(name) {
		var autoFetch = autoFetchMap[name];
		self._references[name] = new ModelInstance(autoFetch.getReference(), references[name], null);
	})
};
