...
Firestarter.controller = function(ControllerConstructor) {
	util.inherits(ControllerConstructor, require('./controller'));
};

Firestarter.model = function(ModelConstructor) {
	util.inherits(ModelConstructor, require('./model'));
};
