    ...
    */
    ...
    this.tasks.forEach(function(existingTask) {
        if(existingTask.name == 'editModel') {
            var exists = Object.keys(existingTask.params.addedProperties).some(function(propertyName) {
                return (existingTask.params.addedProperties[propertyName].referenceName == model.getName());
            });
...
Migration.prototype.go = function(direction) {
    ...
    return Q.when(this[direction].call(this))
        .then(function() {
            ...
            console.log('We have new models:');
            ...
            if(modelNames.length > 0 && self.tasks.length > 1) {
                ...
                console.log('Let us revert: ' + revert);
                ...
                return Q.when(self[revert].call(self))
                    .then(function() {
                        ...
                        console.log('Set forward-references:');
                        console.dir(modelNames);
                        ...
                        return Q.when(self[direction].call(self));
                    });
            }
            else {
